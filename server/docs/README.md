...
This directory contains all documentation required to understand how the backend works,
...
**File:** `clerk-inngest-integration.md` [Link](clerk-inngest-integration.md)<br>
...
**File:** `controllers.md` [Link](controllers.md)<br>
...
**File:** `database.md` [Link](database.md)<br>
...
**File:** `middleware.md` [Link](middleware.md)<br>
...
**File:** `routes.md` [Link](routes.md)<br>
...
**File:** `server.md` [Link](server.md)<br>
...
**File:** `stripe-integration.md` [Link](stripe-integration.md)<br>
...
**File:** `system-design.md` [Link](system-design.md)<br>
